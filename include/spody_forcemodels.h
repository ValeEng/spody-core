 ...
 * Internally rotates r_sat ICRF -> body PA via the lunar libration
 * angles at the given Ephemeris Time, evaluates the harmonic series
 * with hg, and rotates the result back to ICRF.
 *
